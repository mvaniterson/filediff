...
class TestCompareDataFrames(unittest.TestCase):
    ...
    def setUp(self):
        self.a = pd.DataFrame({'col_1': ['a', 'b', 'c'], 'col_2': [1, 2, 3], 'col_3': [1.1, 1.2, 1.3]})
        self.c = pd.DataFrame({'col_1': ['a', 'b'], 'col_2': [1, 2], 'col_3': [1.1, 1.2]})
        self.d = pd.DataFrame({'col_1': ['a', 'b', 'c'], 'col_2': [1, 2, 3]})
        self.e = pd.DataFrame({'col_2': [1, 2, 3], 'col_1': ['a', 'b', 'c'], 'col_3': [1.1, 1.2, 1.3]})
        self.f = pd.DataFrame({'col_0': ['a', 'b', 'c'], 'col_2': [1, 2, 3], 'col_3': [1.1, 1.2, 1.3]})
        self.g = pd.DataFrame({'col_1': ['a', 'b', 'c'], 'col_2': [1.0, 2.0, 3.0], 'col_3': [1.1, 1.2, 1.3]})
        self.h = pd.DataFrame({'col_2': [1, 2, 3], 'col_3': [1.1, 1.2, 1.3], 'col_1': ['a', 'b', 'd']})
